...
import { Package, ArrowLeft, Tag, Box, Phone, MapPin, Clock, ChevronRight, Percent, ShoppingBag } from 'lucide-react';
...
export default function ProductView() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-surface-100 to-white">
      ...
      <div className="bg-white/80 backdrop-blur-lg border-b border-surface-200/50 sticky top-0 z-10">
